...
exports.CSS_VARS = exports.FAIL_PASS_RATIO = exports.MISSION_TIMER_SECONDS = exports.ANALYZE_MOCK_DELAY_MS = exports.TRAINING_SPLASH_DURATION_MS = exports.BUG_ALERT_DURATION_MS = exports.BOOT_DURATION_MS = exports.DIALOGUE = exports.PUNISHMENT_REQUIRED_REPS = exports.PUNISHMENT_PHRASE = void 0;
...
exports.BOOT_DURATION_MS = 1400;
/** Suspicion alert duration in milliseconds */
exports.BUG_ALERT_DURATION_MS = 1000;
/** Training splash duration in milliseconds */
exports.TRAINING_SPLASH_DURATION_MS = 1000;
/** Mock analyzer delay in milliseconds */
exports.ANALYZE_MOCK_DELAY_MS = 1000;
