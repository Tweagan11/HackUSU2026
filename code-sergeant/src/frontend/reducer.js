...
exports.initialState = {
    ...
    resultMessage: '',
    punishment: '',
    punishmentPhrase: config_1.PUNISHMENT_PHRASE,
    punishmentRequiredReps: config_1.PUNISHMENT_REQUIRED_REPS,
    ...
    switch (action.type) {
        ...
        case 'BUG_ALERT_COMPLETE':
            ...
            return {
                ...
                dialogueLog: addDialogue(state.dialogueLog, randomItem(config_1.DIALOGUE.alert)),
            };
        case 'TRAINING_SPLASH_COMPLETE':
            ...
            return {
                ...
                dialogueLog: addDialogue(state.dialogueLog, randomItem(config_1.DIALOGUE.briefing)),
            };
        case 'SET_CODE':
        ...
        case 'RESULT_FAIL': {
            ...
            const punishmentPhrase = normalizedPhrase && normalizedPhrase.length > 0
                ? normalizedPhrase
                : config_1.PUNISHMENT_PHRASE;
            const punishmentRequiredReps = typeof action.punishmentReps === 'number' && Number.isFinite(action.punishmentReps) && action.punishmentReps > 0
                ? action.punishmentReps
                : config_1.PUNISHMENT_REQUIRED_REPS;
        ...
        case 'PUNISHMENT_LINE_COMPLETED':
            if (state.uiState !== 'RESULT_FAIL' || state.retryUnlocked)
                return state;
            const nextProgress = Math.min(state.punishmentProgress + 1, state.punishmentRequiredReps);
            return {
                ...state,
