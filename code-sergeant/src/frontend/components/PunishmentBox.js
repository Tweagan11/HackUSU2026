 ...
 */
const PunishmentBox = ({ punishment, visible, phrase, requiredReps, progress, onLineCompleted, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "punishment-box", children: [(0, jsx_runtime_1.jsx)("div", { className: "punishment-box__header", children: "\u26A0 PUNISHMENT \u26A0" }), (0, jsx_runtime_1.jsx)("div", { className: "punishment-box__text", children: displayedText }), (0, jsx_runtime_1.jsx)("div", { className: "punishment-box__progress", children: totalReps > 0
                    ? `${Math.min(progress, totalReps)}/${totalReps} completed`
                    : 'No punishment required' }), !isComplete && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("input", { className: "punishment-box__input", type: "text", value: lineInput, onChange: (e) => setLineInput(e.target.value), onKeyDown: (e) => {
                            if (e.key === 'Enter') {
                                submitLine();
                            }
                        }, placeholder: phrase, "aria-label": "Punishment phrase input" }), (0, jsx_runtime_1.jsx)("button", { className: "punishment-box__submit", type: "button", onClick: submitLine, children: "Submit Line" })] })), error && (0, jsx_runtime_1.jsx)("div", { className: "punishment-box__error", children: error }), isComplete && ((0, jsx_runtime_1.jsx)("div", { className: "punishment-box__done", children: "Punishment complete. Retry is unlocked." }))] }));
};
