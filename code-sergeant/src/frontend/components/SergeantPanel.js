 ...
 */
const SergeantPanel = ({ uiState, missionInstructions, dialogueLog, punishment, punishmentPhrase, punishmentRequiredReps, punishmentProgress, showPunishment, onPunishmentLineCompleted, onSubmit, onResubmit, onNextMission, canRetryAfterPunishment, }) => {
    return ((0, jsx_runtime_1.jsxs)("div", { className: "sergeant-panel", children: [missionInstructions && ((0, jsx_runtime_1.jsxs)("div", { className: "sergeant-panel__instructions", children: [(0, jsx_runtime_1.jsx)("span", { className: "instructions-label", children: "MISSION OBJECTIVE:" }), (0, jsx_runtime_1.jsx)("p", { className: "instructions-text", children: missionInstructions })] })), (0, jsx_runtime_1.jsx)("div", { className: "sergeant-panel__dialogue", children: (0, jsx_runtime_1.jsx)(DialogueLog_1.default, { entries: dialogueLog }) }), (0, jsx_runtime_1.jsx)("div", { className: "sergeant-panel__punishment", children: (0, jsx_runtime_1.jsx)(PunishmentBox_1.default, { punishment: punishment, visible: showPunishment, phrase: punishmentPhrase, requiredReps: punishmentRequiredReps, progress: punishmentProgress, onLineCompleted: onPunishmentLineCompleted }) }), (0, jsx_runtime_1.jsx)("div", { className: "sergeant-panel__action", children: (0, jsx_runtime_1.jsx)(ActionButton_1.default, { uiState: uiState, onSubmit: onSubmit, onResubmit: onResubmit, onNextMission: onNextMission, canRetryAfterPunishment: canRetryAfterPunishment }) })] }));
};
