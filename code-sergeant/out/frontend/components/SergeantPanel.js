 ...
 */
const SergeantPanel = ({ uiState, dialogueLog, punishment, showPunishment, onSubmit, onRetry, onNextMission, callStatus, callError, phoneNumber, onPhoneNumberChange, onCallSergeant, }) => {
